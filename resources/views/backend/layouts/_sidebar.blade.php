    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('admin/barang')}}" class="nav-link @if(
                Request::segment(2) == 'barang') active @endif">
          ...
          <li class="nav-item">
            <a href="{{ url('admin/kasir')}}" class="nav-link @if(
                Request::segment(2) == 'kasir') active @endif">
          ...
          <li class="nav-item">
            <a href="{{ url('admin/tenan')}}" class="nav-link @if(
                Request::segment(2) == 'tenan') active @endif">
